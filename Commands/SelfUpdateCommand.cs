    ...
    public class SelfUpdateCommand : CommandBase
    {
        ...
        public void UpdateIfOld()
        {
            try
            {
                ...
                isAutoUpdate = true;
                new SelfUpdateCommand().Run(new[] {"self-update"});
            }
...
exit $exit_code";
        ...
        private void InstallPowerShell()
        {
            ...
            const string importStr = "Import-Module cementPM 3>$null";
        ...
        private void InstallBashScript()
        {
            ...
            const string toAdd = ". ~/bin/dotnet/bash-completion";
