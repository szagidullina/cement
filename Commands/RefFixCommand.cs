...
namespace Commands
{
    public class RefFixCommand : CommandBase
    {
        ...
        private void Fix(BuildData buildInfo, IEnumerable<Module> modules, HashSet<string> processedFiles)
        {
        ...
        private class FixReferenceResult
        {
