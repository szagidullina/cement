...
namespace Commands
{
    public class BuildDepsCommand : CommandBase
    {
        ...
        private bool BuildDepsSequential(ModulesOrder modulesOrder, BuiltInfoStorage builtStorage, List<Dep> modulesToBuild, 
        ...
        private bool BuildDepsParallel(ModulesOrder modulesOrder, BuiltInfoStorage builtStorage, List<Dep> modulesToBuild, ModuleBuilder builder)
        {
        ...
        public void TryNugetRestore(IEnumerable<Dep> modulesToUpdate, ModuleBuilder builder)
        {
        ...
        private bool NoNeedToBuild(Dep dep, ICollection<Dep> modulesToBuild)
        {
