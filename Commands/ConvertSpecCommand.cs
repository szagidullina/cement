...
namespace Commands
{
    public class ConvertSpecCommand : CommandBase
    {
        ...
        protected override int Execute()
        {
            ...
            var configurationsParser = ConfigurationParser.Create(new FileInfo(Directory.GetCurrentDirectory()));
        ...
        private static List<Dep> RelaxDeps(List<Dep> deps, List<Dep> childrenDeps)
        {
            if (deps == null)
                return null;
        ...
        private static BuildData GetBuildData(string configuration)
        {
