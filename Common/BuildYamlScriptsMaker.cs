...
namespace Common
{
    public static class BuildYamlScriptsMaker
    {
        ...
        private static List<string> GetDefaultMsbuildParameters(Tool tool)
        {
            ...
            if (!PlatformHelper.OsIsUnix() && VisualStudioHelper.IsVisualStudioVersion(toolVersion))
        ...
        private static List<string> GetDefaultMsbuildParameters(string toolName)
        {
            ...
            return (PlatformHelper.OsIsUnix() ? DefaultXbuildParameters : DefaultMsbuildParameters).ToList();
        }
